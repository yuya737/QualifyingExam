...
\title[HexTiles and Semantic Icons for Multivariate Geospatial Visualizations]%
      {HexTiles and Semantic Icons\\ for Multivariate Geospatial Visualizations}

% for anonymous conference submission please enter your SUBMISSION ID
% instead of the author's name (and leave the affiliation blank) !!
% for final version: please provide your *own* ORCID in the brackets following \orcid; see https://orcid.org/ for more details.
\author[Submission ID]{Submission ID: 1201}

\begin{comment}
\author[Y.Kawakami, S. Yuniar, and K.L. Ma]
% {The Authors}
{\parbox{\textwidth}{\centering Y. Kawakami, S. Yuniar, and K.L. Ma
        }
        \\
% For Computer Graphics Forum: Please use the abbreviation of your first name.
{\parbox{\textwidth}{\centering University of California, Davis
       }
}
}
\end{comment}
...
\vspace{-0.2in}
 ...
 \centering
  \caption{A HexTiles encoding of CalSim3 \cite{CalSim3} output. Data details are described in \cref{sec:cases}. Left shows the breakdown of the HexTiles encoding used here, and the right is a view of California's Central Valley with following the encoding on the left. With HexTiles, we can efficiently encode multivariate data on a geospatial map using hexagonal tiling and semantic icons. Here, we encode four variables related to CalSim3 water allocation in the Central Valley in California,
  in HexTile color, semantic icons, HexTile inner ring color, and HexTile height, carefully overlaid to balance discipherability and information content.}
\label{fig:teaser}
}
...
%-------------------------------------------------------------------------
\begin{abstract}
    We introduce \textit{HexTiles}, a domain-agnostic hexagonal-tiling based visual encoding method
    for multivariate geospatial data for the general public. Multivariate geospatial data, especially those beyond 
    two variables, have consistently presented a challenge due to the rigid graph schema associated 
    with geospatial maps, on which most geospatial data is presented. We find that the overreliance on color to represent geospatial data, via choropleth maps or bivariate colormaps, for example, can make immediate sense-making more difficult.
    ...
    geospatial data. To validate our approach, we gather expert review from ecologists and hydrologists to evaluate the efficacy of our visual encoding.
...
\input{cases}
\section{Expert Review}\label{sec:feedback}
\input{feedback}
