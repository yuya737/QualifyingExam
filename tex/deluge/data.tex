...
%
Within each 75$\times$75\,km grid cell, we further discretize space into a 64$\times$64 raster of \textit{pixels} ($\sim$1.17\,km on a side), which constitute the unit of spatial prediction throughout the remainder of the chapter.
%
